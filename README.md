...
- **The Anchor:** Uses **inverse-volatility weighting** (a simplified risk-based anchor; note this is not full risk parity / ERC, as it ignores cross-asset correlations) to calculate a diversified market-equilibrium portfolio. This ensures safety and diversification by default.
